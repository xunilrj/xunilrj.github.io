...
var WebVtt = /** @class */ (function () {
    function WebVtt() {
        this.cues = [];
    }
    WebVtt.prototype.parse = function (content) {
        if (content == null) {
    ...
    WebVtt.prototype.dump = function () {
        var index = 0;
    ...
    WebVtt.prototype.get_cues = function () {
        return this.cues;
    };
    WebVtt.prototype.set_cues = function (cues) {
        this.cues = cues;
    };
    return WebVtt;
}());
